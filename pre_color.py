...
class plot_label(object):
    def __init__(self,data_name='PaviaU'):
    ...
    def set_default(self):
        ...
        elif 'hongtu' in self.data_name:
            self.dim = 8
            
            if '1' in self.data_name:
                self.shape = [357, 702, 3]
            elif '2' in self.data_name:
                self.shape = [371, 711, 3]
            elif '3' in self.data_name:
    ...
    def plot_color(self,pre):
        ...
        for i in range(self.dim):
            img=self.change_data(pre1,img,i)
        return img
